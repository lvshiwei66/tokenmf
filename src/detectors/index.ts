...
const DETECTOR_CONFIGS: DetectorConfig[] = [
  ...
  { name: "opencode", configDirName: ".config", configFileName: "opencode/opencode.json", configFormat: "json", executableNames: ["opencode"] },
  { name: "hermes", configDirName: ".hermes", configFileName: "config.yaml", configFormat: "yaml", executableNames: ["hermes"] },
  { name: "pi", configDirName: ".pi", configFileName: "agent/settings.json", configFormat: "json", executableNames: ["pi"] },
];
